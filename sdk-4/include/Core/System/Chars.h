...
#define vchrPageUpWhenOff		0x020E			// The m100 device's page-up clock button
#define vchrHardEarbud			0x020F			// Hypothetical Earbud button
...
//		Palm
#define	vchrPalmMin					0x1700			// 256 command keys
