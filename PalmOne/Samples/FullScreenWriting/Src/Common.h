...
#define FrmSetFocusID(formP, id)  FrmSetFocus(formP, FrmGetObjectIndex(formP, id))
#define FrmGetFocusID(formP)   FrmGetObjectId(formP, FrmGetFocus(formP))
#define FrmMoveID(formP, id, dx, dy) \
 { \
  Coord _x_FrmMoveID, _y_FrmMoveID; \
  UInt16 _index_FrmMoveID; \
  \
  _index_FrmMoveID = FrmGetObjectIndex(formP, id); \
  FrmGetObjectPosition(formP, _index_FrmMoveID, &_x_FrmMoveID, &_y_FrmMoveID); \
  _x_FrmMoveID += dx; \
  _y_FrmMoveID += dy; \
  FrmSetObjectPosition(formP, _index_FrmMoveID, _x_FrmMoveID, _y_FrmMoveID); \
 }
