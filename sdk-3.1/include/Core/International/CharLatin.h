 ...
 * File		CharLatin.h
 * Author	Ken Krugler
 * Purpose	Header file for Microsoft code page 1252 character encoding
 *			(Microsoft extension to ISO 8859-1 character encoding).
 *
 * Agenda
 *	kwk - Sync fonts (add Euro, upper/lower-case Z caron).
 *	kwk - Fill in full set of Unicode alias names.
 *
 * History
 *	05 Mar 98	kwk	New today.
 *	15 Apr 98	kwk	Moved 1252-specific #defines here from Chars.h.
 *				kwk	Only include these #defines if NON_INTERNATIONAL
 *					is defined.
 *	27 May 98	kwk	Minor cleanup from Art's mods to my earlier file.
 *				kwk	Deleted playing card chars, commandStrokeChr, and
 *					shortcutStrokeChr.
 *	29 May 98	kwk	Changed the name of numericSpaceChr to numericSpace1252Chr,
 *					and horizEllipsisChr to horizEllipsis1252Chr, to
 *					avoid name collision with new versions of these chars
 *					located at 0x18 & 0x19 (defined in Chars.h).
 *	11 Jun 98	kwk	Changed chrCircumplexAccent to chrModifierCircumflexAccent,
 *					to match Unicode name and prevent name collision with
 *					the chrCircumflexAccent char at 0x5E.
 *				kwk	Changed chrHorizontalEllipsis to chrHorizontalEllipsis1252,
 *					to avoid collision with chrHorizontalEllipsis located
 *					in control range.
 *	30 Jun 98	kwk	Changed name from CharCP1252.h to CharLatin.h.
 *	20 Oct 98	kwk	Filled out everything but alias Unicode names.
 *	21 Oct 98	kwk	Commented out upper & lower-case Z caron defines, since
 *					these two chars aren't in the fonts yet.
 *
 ***********************************************************************/
...
// Character codes that are part of code page 1252, but not guaranteed
...
// Undefined									0x0080	// Was numeric space (valid thru 3.2)
														// Will become Euro char in future.
// Undefined									0x0081
...
// Undefined									0x008F	// Was heartChr
// Undefined									0x0090	// Was spadeChr
...
#define	shortcutStrokeChr			0x9E	//	** COPIED TO 0x17; will be removed **
