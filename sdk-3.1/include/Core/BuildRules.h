 ...
 *************************************************************/ 
	...
	#define	INTERNATIONAL_MGR		INTERNATIONAL_MGR_OFF
#endif
...
// Let it be known that these paths SHOULD have been language-based
// rather than country-based...  (e.g. "Localized:French:")
#elif 	LANGUAGE == LANGUAGE_FRENCH
#define RESOURCE_FILE_PREFIX "Localized:France:"

#elif 	LANGUAGE == LANGUAGE_GERMAN
#define RESOURCE_FILE_PREFIX "Localized:Germany:"

#elif 	LANGUAGE == LANGUAGE_ITALIAN
#define RESOURCE_FILE_PREFIX "Localized:Italy:"

#elif 	LANGUAGE == LANGUAGE_SPANISH
#define RESOURCE_FILE_PREFIX "Localized:Spain:"

#elif 	LANGUAGE == LANGUAGE_WORKPAD
#define RESOURCE_FILE_PREFIX "Localized:WPEng:"

#elif 	LANGUAGE == LANGUAGE_JAPANESE
#define RESOURCE_FILE_PREFIX "Localized:Japan:"
#endif
